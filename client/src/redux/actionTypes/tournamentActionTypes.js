...
export const GET_TAKEN_TEAMS_SUCCESS = 'GET_TAKEN_TEAMS_SUCCESS';

export const UPDATE_TOURNAMENT_PARTICIPANTS_SOCKET = 'UPDATE_TOURNAMENT_PARTICIPANTS_SOCKET';

export const ADD_TOURNAMENT_SOCKET = 'ADD_TOURNAMENT_SOCKET';