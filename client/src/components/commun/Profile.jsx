...
const Profile = ({ profileForOtherUser = null }) => {
  ...
  const unlockedAchievements = useMemo(() => {
    return (profileData?.achievements || [])
      .filter((a) => a.achievement && a.achievement.title && a.achievement.description) 
            ...
            <Card.Body className="p-4 text-center d-flex flex-column">
              ...
              <div className="d-flex flex-wrap justify-content-center align-items-center gap-2 mb-2">
                <Badge
                  ...
                  className="status-badge-lg px-2 py-1"
                >
                  {profileData.blocked ? (
              ...
              {profileData.isMediatorQualified && (
                <Badge
                  ...
                  bg="warning"
                  text="dark"
                  className="mediator-badge-lg mt-2 px-2 py-1 d-inline-block mx-auto"
                  ...
                  {unlockedAchievements.map((userAchievement) => (
                    <Col key={userAchievement.achievement._id} xs="auto">
                      <OverlayTrigger
                        ...
                        overlay={
                          <Tooltip
                            id={`tooltip-${userAchievement.achievement._id}`}
                          >
                            <strong>
                              {userAchievement.achievement.title?.[i18n.language] || userAchievement.achievement.title?.ar || "Achievement Unlocked"}
                            </strong>
                            <br />
                            <small>
                              {userAchievement.achievement.description?.[i18n.language] || userAchievement.achievement.description?.ar || ""}
                            </small>
                          </Tooltip>
                        }
                      >
                      ...
                      <LinkContainer to="/dashboard/achievements">
                        <Button variant="link" size="sm" className="p-0">
                          {t("profilePage.viewAllAchievements", {
                            count: profileData.achievements.length,
                          })}
                        </Button>
                      </LinkContainer>
                    </Col>
